...
export default function SimplePRFCTA() {
  return (
    <section className="py-16 lg:py-20" style={{ backgroundColor: '#441018' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            Join hundreds of patients who have benefited from our PRF therapy procedures. 
            Experience faster healing and better results with our advanced treatment.
          </motion.p>
          ...
          >
            Call (209) 825-1030 or fill out our online form
          </motion.p>
        </motion.div>
      </div>
    </section>
