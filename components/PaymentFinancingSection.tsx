      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex items-center mb-8">
            ...
            <h3 className="text-2xl font-bold text-gray-900">Financing Options</h3>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow duration-300">
              <div className="flex items-center justify-between mb-4">
                <h4 className="text-xl font-semibold text-gray-900">Sunbit</h4>
              ...
              <a href="https://sunbit.com" target="_blank" rel="noopener noreferrer" className="text-[#441018] hover:underline font-medium">
            ...
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow duration-300">
              ...
              <a href="https://carecredit.com" target="_blank" rel="noopener noreferrer" className="text-[#441018] hover:underline font-medium">
          ...
          <div className="mt-8 p-6 bg-gray-50 rounded-lg">
            <h4 className="font-semibold text-gray-900 mb-3">More About CareCredit</h4>
        ...
        >
          <div className="bg-[#441018] rounded-xl p-8 max-w-2xl mx-auto">
