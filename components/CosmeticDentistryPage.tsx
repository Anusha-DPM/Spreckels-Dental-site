...
export default function CosmeticDentistryPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Maintaining Your New Smile Section */}
      ...
      {/* Dental Care and Insurance Section */}
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="px-8 py-4 bg-transparent text-white border border-white rounded-lg font-semibold hover:bg-white hover:text-[#441018] transition-colors duration-200 text-[15px] sm:text-base">
                Learn More
              </button>
            </div>
          </motion.div>
