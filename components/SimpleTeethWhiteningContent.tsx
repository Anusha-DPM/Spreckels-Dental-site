    ...
    <section className="py-16 lg:py-20 bg-gradient-to-br from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed" style={{ color: '#656565' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 h-full">
                ...
                <h4 className="text-2xl font-bold text-gray-900 mb-4">In-Office Teeth Whitening</h4>
                <p className="text-gray-600 leading-relaxed mb-4" style={{ color: '#656565' }}>
                  Professional in-office treatment where a dental professional applies a whitening gel to your teeth.
                </p>
                <ul className="space-y-2 text-gray-600" style={{ color: '#656565' }}>
            ...
            >
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 h-full">
                ...
                <h4 className="text-2xl font-bold text-gray-900 mb-4">At-Home Professional Whitening</h4>
                <p className="text-gray-600 leading-relaxed mb-4" style={{ color: '#656565' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 h-full">
                ...
                <h4 className="text-xl font-bold text-gray-900 mb-3">Paint-On Teeth Whiteners</h4>
                <p className="text-gray-600 leading-relaxed text-sm" style={{ color: '#656565' }}>
            ...
            >
              <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 h-full">
                ...
                <h4 className="text-xl font-bold text-gray-900 mb-3">Teeth Whitening Strips</h4>
                <p className="text-gray-600 leading-relaxed text-sm" style={{ color: '#656565' }}>
            ...
            >
              <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 h-full">
                ...
                <h4 className="text-xl font-bold text-gray-900 mb-3">Whitening Toothpaste & Mouthwash</h4>
                <p className="text-gray-600 leading-relaxed text-sm" style={{ color: '#656565' }}>
        ...
        >
          <div className="bg-white rounded-2xl p-8 lg:p-12 shadow-lg border border-gray-100">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div>
                <h4 className="text-xl font-semibold text-gray-900 mb-4">Professional Solutions Are Most Effective For:</h4>
                <ul className="space-y-3 text-gray-600" style={{ color: '#656565' }}>
                  <li className="flex items-start">
              ...
              <div>
                <h4 className="text-xl font-semibold text-gray-900 mb-4">May Not Be Effective For:</h4>
                <ul className="space-y-3 text-gray-600" style={{ color: '#656565' }}>
                  <li className="flex items-start">
