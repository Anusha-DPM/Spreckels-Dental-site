          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 h-full">
                ...
                <h4 className="text-2xl font-bold text-gray-900 mb-3">Inhalation Sedation</h4>
            ...
            >
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 h-full">
                ...
                <h4 className="text-2xl font-bold text-gray-900 mb-3">Oral Sedation</h4>
            ...
            >
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 h-full">
                ...
                <h4 className="text-2xl font-bold text-gray-900 mb-3">IV Sedation</h4>
