      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
           ...
           <div className="text-left" style={{ paddingLeft: '90px' }}>
             <h3 className="font-semibold text-gray-300 mb-6">Information</h3>
           ...
           <div className="text-left">
             <h3 className="font-semibold text-gray-300 mb-6">HOURS OF OPERATION</h3>
             <ul className="space-y-2">
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              Copyright: © 2024 Sprekels Park Dental. All Rights Reserved.
            </p>
