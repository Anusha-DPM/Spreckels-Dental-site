          ...
          >
            ...
            <div className="relative z-10 text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button className="px-8 py-4 bg-transparent text-white border border-white rounded-lg font-semibold hover:bg-white hover:text-blue-800 transition-colors duration-200 text-[15px] sm:text-base">
                  Learn More
                </button>
              </div>
            </div>
