...
export const createBlogPost = async (blogData) => {
  try {
    ...
    console.log('✅ Blog post saved to Firebase successfully:', docRef.id)
    ...
    console.log('✅ Blog post saved to localStorage as fallback:', newPost.id)
    return newPost
  }
}
...
export const getBlogPosts = async (options = {}) => {
  try {
    ...
    console.log('✅ Loaded', filteredPosts.length, 'posts from localStorage fallback')
