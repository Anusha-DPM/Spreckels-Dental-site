    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl font-semibold text-gray-900 mb-6 font-heading">Understanding Common Dental Procedures</h2>
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-4 font-heading">Dental Cleanings</h3>
            <p className="text-gray-700 leading-relaxed mb-6 font-sans">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-4 font-heading">Dental Fillings</h3>
            <p className="text-gray-700 leading-relaxed mb-6 font-sans">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-4 font-heading">Root Canal Therapy</h3>
            <p className="text-gray-700 leading-relaxed mb-6 font-sans">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-4 font-heading">Dental Crowns</h3>
            <p className="text-gray-700 leading-relaxed mb-6 font-sans">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-4 font-heading">Dental Bridges</h3>
            <p className="text-gray-700 leading-relaxed mb-6 font-sans">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-4 font-heading">Dental Implants</h3>
            <p className="text-gray-700 leading-relaxed mb-6 font-sans">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-4 font-heading">Tooth Extractions</h3>
            <p className="text-gray-700 leading-relaxed mb-6 font-sans">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-4 font-heading">What to Expect During Dental Procedures</h3>
            <p className="text-gray-700 leading-relaxed mb-6 font-sans">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-4 font-heading">Preparing for Your Dental Visit</h3>
            <p className="text-gray-700 leading-relaxed mb-6 font-sans">
