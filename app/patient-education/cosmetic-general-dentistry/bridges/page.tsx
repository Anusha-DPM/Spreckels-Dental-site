    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl font-semibold text-gray-900 mb-6 font-heading">What are Dental Bridges?</h2>
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-4 font-heading">Types of Dental Bridges</h3>
            <p className="text-gray-700 leading-relaxed mb-6 font-sans">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-4 font-heading">The Bridge Procedure</h3>
            <p className="text-gray-700 leading-relaxed mb-6 font-sans">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-4 font-heading">Benefits of Dental Bridges</h3>
            <p className="text-gray-700 leading-relaxed mb-6 font-sans">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-4 font-heading">Caring for Your Dental Bridge</h3>
            <p className="text-gray-700 leading-relaxed mb-6 font-sans">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-4 font-heading">How Long Do Dental Bridges Last?</h3>
            <p className="text-gray-700 leading-relaxed mb-6 font-sans">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-4 font-heading">Are Dental Bridges Right for You?</h3>
            <p className="text-gray-700 leading-relaxed mb-6 font-sans">
