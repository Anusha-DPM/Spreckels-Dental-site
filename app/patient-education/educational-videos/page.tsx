          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3">
              ...
              <motion.div
                ...
                className="mb-6 sm:mb-8"
              >
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-gray-200 gap-4 sm:gap-0">
                  <div className="flex flex-wrap gap-2 sm:gap-4 md:gap-8 overflow-x-auto -mx-4 px-4 sm:mx-0 sm:px-0">
                    {navigationTabs.map((tab, index) => (
                      <button
                        key={tab}
                        className={`py-3 px-2 sm:px-1 border-b-2 font-semibold text-sm sm:text-sm transition-colors duration-200 whitespace-nowrap ${
                          index === 0 
                  ...
                  <button className="text-blue-600 hover:text-blue-700 text-sm sm:text-sm font-medium whitespace-nowrap self-start sm:self-auto">
                    Share by email
                  </button>
                </div>
              </motion.div>
