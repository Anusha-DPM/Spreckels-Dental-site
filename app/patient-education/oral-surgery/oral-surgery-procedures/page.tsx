    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <ul className="list-disc pl-6 text-gray-700 leading-relaxed font-sans mb-6">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl font-normal text-gray-900 font-heading text-center mb-12">
              Related Articles
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Link href="/patient-education/oral-surgery/extractions" className="group">
                ...
                >
                  <h3 className="text-xl font-normal text-gray-900 font-heading mb-3 group-hover:text-blue-600 transition-colors">
                    Extractions
                  </h3>
