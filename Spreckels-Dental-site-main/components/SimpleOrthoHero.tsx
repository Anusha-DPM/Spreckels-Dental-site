...
export default function SimpleOrthoHero() {
  return (
        ...
        >
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-white bg-opacity-10 px-6 py-3 rounded-lg">
              ...
              <span className="text-blue-300 font-semibold text-lg">invisalign®</span>
            </div>
          </motion.div>
          ...
          >
            Transform your smile with invisible aligners and traditional braces.
            Get the beautiful, straight teeth you've always wanted.
          </motion.p>
