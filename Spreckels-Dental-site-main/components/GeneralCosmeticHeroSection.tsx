        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a 
                href="/contact"
                className="px-8 py-4 bg-transparent text-white border border-white rounded-lg font-semibold hover:bg-white hover:text-[#441018] transition-colors duration-200 cursor-pointer inline-block text-center text-[15px] sm:text-base"
              >
                Learn More
              </a>
            </div>
