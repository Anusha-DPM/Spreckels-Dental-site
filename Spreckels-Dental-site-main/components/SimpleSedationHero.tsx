        ...
        >
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-white bg-opacity-10 px-6 py-3 rounded-lg">
              ...
              <span className="text-blue-300 font-semibold text-lg">Nitrous Oxide</span>
            </div>
          </motion.div>
          ...
          >
            Overcome dental anxiety with safe and effective sedation options.
            Experience comfortable, stress-free dental care in Manteca, CA.
          </motion.p>
